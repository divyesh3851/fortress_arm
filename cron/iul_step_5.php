...
$step_5_subject = get_option('iul_step_5_subject');
...
foreach ($get_advisor_list as $advisor_result) {
    ...
    $step_5_mail_body = get_option('iul_step_5_mail_body');

    $step_5_mail_body  = replace_merge_fields($step_5_mail_body, $merge_fields);
    ...
    //send_mail($advisor_result->email, $step_5_subject, $step_5_mail_body, $attachment);
    $status = send_mail('demo.starline2020@gmail.com', $step_5_subject, $step_5_mail_body, $attachment);
    if ($status) {
        ...
        Admin()->create_mail_log($advisor_result->id, $advisor_result->email, 'advisor_interest_iul_step_5', 'advisor');
