    ...
    if ($advisor_result->interest_id == 4 && $advisor_result->sub_id) {
        ...
        if (3 == $advisor_result->sub_id) {
            ...
            if ($current_step == 2) {
                ...
                //$status = send_mail($advisor_result->email, $subject, $mail_body, $attachment);
                $status = send_mail('demo.starline2020@gmail.com', $subject, $mail_body, $attachment);
                ...
                if ($status) {
                    ...
                    $wpdb->update("interest", array("mail_reminder" => $next_mail_reminder_date), array("id" => $advisor_result->user_interest_tbl_id));
