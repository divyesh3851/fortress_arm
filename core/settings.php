...
define( 'TEMPLATEPATH', WP_CONTENT_DIR . '/themes' );
define( 'STYLESHEETPATH', WP_CONTENT_DIR . '/themes' );
define( 'WP_DEFAULT_THEME', 'one' );
...
// Load admin function
if ( defined( 'SITE_ADMIN_DIR' ) && file_exists( SITE_ADMIN_DIR . '/functions.php' ) ) {
	require_once SITE_ADMIN_DIR . '/functions.php';
}

// Load apps
require ABSPATH . 'apps.php';
