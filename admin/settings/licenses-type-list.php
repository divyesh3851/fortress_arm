...
if (isset($_POST['save_license_type'])) {
    ...
    if (!empty(sipost('license_type_id'))) {
        $response = Settings()->update_license_type();
    } else {
        $response = Settings()->add_license_type();
    }
    ...
    wp_redirect(site_url() . '/admin/settings/licenses-type-list');
    exit;
}

if (isset($_POST['licenses_type_export_submit'])) {
    ...
    if ($format == 'excel') {
        ...
        $filename    = "Licenses Type List - " . date('Y_m_d') . ".csv";
        ...
        $path = "Licenses Type List - " . date('Y_m_d') . ".pdf";
...
<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" data-kt-app-aside-enabled="true" data-kt-app-aside-fixed="true" data-kt-app-aside-push-toolbar="true" data-kt-app-aside-push-footer="true" class="app-default">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                                ...
                                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                    ...
                                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                                        <!--begin::Title-->
                                        <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Types of Licenses List</h1>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Page title-->
                                    <!--begin::Actions-->
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                <?php if (isset($_SESSION['process_success'])) {
                                    ...
                                    <div class="alert alert-success d-flex align-items-center p-5">
                                        ...
                                        <div class="d-flex flex-column">
                                            <h4 class="mb-1 text-success">The license type has been save successfully.</h4>
                                        </div>
                                    </div>
                                <?php }
                                ...
                                if (isset($_SESSION['process_duplicate'])) {
                                    ...
                                    <div class="alert alert-danger d-flex align-items-center p-5">
                                        ...
                                        <div class="d-flex flex-column">
                                            <h4 class="mb-1 text-danger">The license type has been already exist.</h4>
                                        </div>
                                    </div>
                                <?php }
                                ...
                                if (isset($_SESSION['process_fail'])) {
                                    ...
                                    <div class="alert alert-danger d-flex align-items-center p-5">
                                        <i class="ki-duotone ki-shield-tick fs-2hx text-danger  me-4"><span class="path1"></span><span class="path2"></span></i>
                                        <div class="d-flex flex-column">
                                            <h4 class="mb-1 text-danger">The licenses type has been save failed.</h4>
                                        </div>
                                    </div>
                                <?php } ?>
                                    ...
                                    <div class="card-header border-0 pt-6">
                                        ...
                                        <div class="card-title">
                                            ...
                                            <div class="d-flex align-items-center position-relative my-1">
                                                ...
                                                <input type="text" data-kt-docs-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Licenses Type" />
                                            </div>
                                            <!--end::Search-->
                                        </div>
                                        <!--begin::Card title-->
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                                                ...
                                                <!--begin::Add license-->
                                                <button type="button" class="btn btn-primary license_type_modal" data-bs-toggle="modal" data-bs-target="#kt_modal_license_type" title="Add License Type">
    ...
    <div class="modal fade" id="kt_modal_license_type" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
            ...
            <div class="modal-content modal-rounded">
                ...
                <div class="modal-body scroll-y m-5">
                    ...
                    <form id="kt_modal_add_user_form" class="form" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="license_type_id" id="license_type_id" class="is_empty">
                        <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                            ...
                            <div class="row mb-7">
                                <div class="col-md-12 fv-row">
                                    <!--begin::Label-->
                                    <label class="required fw-semibold fs-6 mb-2">License Type</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="license_type" id="license_type" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="License Type" required />
                                    <!--end::Input-->
                                </div>
                            </div>
                            <!--end::Input group-->
                        ...
                        <div class="text-center pt-10">
                            <button type="submit" name="save_license_type" id="save_license_type" class="btn btn-primary" data-kt-users-modal-action="submit">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">Export License Type</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-10 my-7">
                    ...
                    <form id="" class="form" method="post">
                        ...
                        <div class="text-center">
                            <button type="reset" id="licenses_type_export_cancel" class="btn btn-light me-3">Discard</button>
                            <button type="submit" id="licenses_type_export_submit" name="licenses_type_export_submit" class="btn btn-primary">
                                <span class="indicator-label">Submit</span>
                                <span class="indicator-progress">Please wait...
                                    <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                            </button>
    ...
    <script>
        ...
        var KTDatatablesServerSide = function() {
            ...
            var initDatatable = function() {
                dt = $("#kt_datatable_example_1").DataTable({
                    ...
                    ajax: {
                        url: "<?php echo site_url(); ?>/admin/settings/licenses-type-list-ajax.php",
                    },
                    columns: [{
                            data: 'record_id'
                        },
                        ...
                        },
                        {
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3"> 
                                    <a href="#" license_type_id="${data.record_id}" class="menu-link px-3 license_type_modal" data-bs-toggle="modal" data-bs-target="#kt_modal_license_type" data-kt-docs-table-filter="edit_row">
                                        Edit
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-docs-table-filter="delete_row" license_type_id="${data.record_id}">
                                        Delete
                                    </a>
                                </div>
                                <!--end::Menu item-->
            ...
            var handleDeleteRows = () => {
                ...
                deleteButtons.forEach(d => {
                    ...
                    d.addEventListener('click', function(e) {
                        ...
                        var license_type_id = d.getAttribute('license_type_id');
            ...
            var handleResetForm = () => {
                ...
                if (resetButton) {
                    resetButton.addEventListener('click', function() {
                        ...
                        filterLicenseType[0].checked = true;
        ...
        $(document).on("click", ".license_type_modal", function() {

            var license_type_id = $(this).attr('license_type_id');
            ...
            $.post(ajax_url, {
                action: 'get_selected_license_type_data',
                license_type_id: license_type_id,
                is_ajax: true,
            }, function(result) {
                ...
                if (results) {
                    ...
                    $("#license_type").val(results.license_type_info.type);
