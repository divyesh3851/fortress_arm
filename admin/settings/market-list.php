...
if (isset($_POST['save_market'])) {
    ...
    if (!empty(sipost('id'))) {
        $response = Settings()->update_market();
    } else {
        $response = Settings()->add_market();
    }
    ...
    wp_redirect(site_url() . '/admin/settings/market-list');
    exit;
}
...
if (isset($_POST['market_export_submit'])) {
    ...
    if ($format == 'excel') {
        ...
        $filename    = "Market List - " . date('m-d-Y') . ".csv";
...
<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" data-kt-app-aside-enabled="true" data-kt-app-aside-fixed="true" data-kt-app-aside-push-toolbar="true" data-kt-app-aside-push-footer="true" class="app-default">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                                ...
                                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                    ...
                                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                                        <!--begin::Title-->
                                        <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Market List</h1>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Page title-->
                                    <!--begin::Actions-->
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                <?php if (isset($_SESSION['process_success'])) {
                                    ...
                                    <div class="alert alert-success d-flex align-items-center p-5">
                                        ...
                                        <div class="d-flex flex-column">
                                            <h4 class="mb-1 text-success">The market has been save successfully.</h4>
                                        </div>
                                    </div>
                                <?php }
                                ...
                                if (isset($_SESSION['process_duplicate'])) {
                                    ...
                                    <div class="alert alert-danger d-flex align-items-center p-5">
                                        ...
                                        <div class="d-flex flex-column">
                                            <h4 class="mb-1 text-danger">The market has been already exist.</h4>
                                        </div>
                                    </div>
                                <?php }
                                ...
                                if (isset($_SESSION['process_fail'])) {
                                    ...
                                    <div class="alert alert-danger d-flex align-items-center p-5">
                                        <i class="ki-duotone ki-shield-tick fs-2hx text-danger  me-4"><span class="path1"></span><span class="path2"></span></i>
                                        <div class="d-flex flex-column">
                                            <h4 class="mb-1 text-danger">The market has been save failed.</h4>
                                        </div>
                                    </div>
                                <?php } ?>
                                    ...
                                    <div class="card-header border-0 pt-6">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                                                ...
                                                <!--begin::Add market volume-->
                                                <button type="button" class="btn btn-primary market_modal" data-bs-toggle="modal" data-bs-target="#kt_modal_market" title="Add Market Volume">
                                                    <i class="ki-duotone ki-plus fs-2"></i>
                                                    Add Market
                                                </button>
                                                <!--end::Add market volume-->
    ...
    <div class="modal fade" id="kt_modal_market" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
                ...
                <div class="modal-body scroll-y m-5">
                    ...
                    <form id="kt_modal_add_user_form" class="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                            ...
                            <div class="row mb-7">
                                <div class="col-md-12 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="market" id="market" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="Market" required />
                                    <!--end::Input-->
                                </div>
                            </div>
                            <!--end::Input group-->
                        ...
                        <div class="text-center pt-10">
                            <button type="submit" name="save_market" id="save_market" class="btn btn-primary" data-kt-users-modal-action="submit">
        ...
        var KTDatatablesServerSide = function() {
            ...
            var initDatatable = function() {
                dt = $("#kt_datatable_example_1").DataTable({
                    ...
                    ajax: {
                        url: "<?php echo site_url(); ?>/admin/settings/market-list-ajax.php",
                    },
                    columns: [{
                            data: 'record_id'
                        },
                        ...
                        },
                        {
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3"> 
                                    <a href="#" id="${data.record_id}" class="menu-link px-3 market_modal" data-bs-toggle="modal" data-bs-target="#kt_modal_market" data-kt-docs-table-filter="edit_row">
                                        Edit
                                    </a>
                                </div>
                                <!--end::Menu item-->
