...
$page_name = 'settings';
$sub_page_name = 'designation-list';
Admin()->check_login();
...
if (isset($_POST['save_designation'])) {
    ...
    if (!empty(sipost('designation_id'))) {
        $response = Settings()->update_designation();
    } else {
        $response = Settings()->add_designation();
    }
    ...
    wp_redirect(site_url() . '/admin/settings/designation-list');
    exit;
}

if (isset($_POST['designation_export_submit'])) {
    ...
    if ($format == 'excel') {
        ...
        $filename    = "Designation List - " . date('Y_m_d') . ".csv";
        ...
        $path = "Designation List - " . date('Y_m_d') . ".pdf";
...
<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" data-kt-app-aside-enabled="true" data-kt-app-aside-fixed="true" data-kt-app-aside-push-toolbar="true" data-kt-app-aside-push-footer="true" class="app-default">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                                ...
                                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                    ...
                                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                                        <!--begin::Title-->
                                        <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Designation List</h1>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Page title-->
                                    <!--begin::Actions-->
                                    ...
                                    <div class="card-header border-0 pt-6">
                                        ...
                                        <div class="card-title">
                                            ...
                                            <div class="d-flex align-items-center position-relative my-1">
                                                ...
                                                <input type="text" data-kt-docs-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Designation" />
                                            </div>
                                            <!--end::Search-->
                                        </div>
                                        <!--begin::Card title-->
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                                                ...
                                                <!--end::Export-->
                                                <!--begin::Add Designation-->
                                                <button type="button" class="btn btn-primary designation_modal" data-bs-toggle="modal" data-bs-target="#kt_modal_designation" title="Add Designation">
            ...
            <div class="modal-content modal-rounded">
                ...
                <div class="modal-body scroll-y m-5">
                    ...
                    <form id="kt_modal_add_user_form" class="form" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="designation_id" id="designation_id" class="is_empty">
                        <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                            ...
                            <div class="row mb-7">
                                <div class="col-md-12 fv-row">
                                    <!--begin::Label-->
                                    <label class="required fw-semibold fs-6 mb-2">Initials</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="initials" id="initials" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="Initials" required />
                                    <!--end::Input-->
                                </div>
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                <div class="col-md-12 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="designation" id="designation" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="Designation" required />
                                    <!--end::Input-->
                                </div>
                            </div>
                            <!--end::Input group-->
                        ...
                        <div class="text-center pt-10">
                            <button type="submit" name="save_designation" id="save_designation" class="btn btn-primary" data-kt-users-modal-action="submit">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">Export Designation</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-10 my-7">
                    ...
                    <form id="" class="form" method="post">
                        ...
                        <div class="text-center">
                            <button type="reset" id="designation_export_cancel" class="btn btn-light me-3">Discard</button>
                            <button type="submit" id="designation_export_submit" name="designation_export_submit" class="btn btn-primary">
                                <span class="indicator-label">Submit</span>
                                <span class="indicator-progress">Please wait...
                                    <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                            </button>
    ...
    <script>
        ...
        var KTDatatablesServerSide = function() {
            ...
            var initDatatable = function() {
                dt = $("#kt_datatable_example_1").DataTable({
                    ...
                    ajax: {
                        url: "<?php echo site_url(); ?>/admin/settings/designation-list-ajax.php",
                    },
                    columns: [{
                            data: 'record_id'
                        },
                        ...
                        },
                        {
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3"> 
                                    <a href="#" designation_id="${data.record_id}" class="menu-link px-3 designation_modal" data-bs-toggle="modal" data-bs-target="#kt_modal_designation" data-kt-docs-table-filter="edit_row">
                                        Edit
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-docs-table-filter="delete_row" designation_id="${data.record_id}">
                                        Delete
                                    </a>
                                </div>
                                <!--end::Menu item-->
            ...
            var handleFilterDatatable = () => {
                ...
                filterDesignation = document.querySelectorAll('[data-kt-docs-table-filter="designation_status"] [name="designation_status"]');
                ...
                if (filterButton) {
                    filterButton.addEventListener('click', function() {
                        // Get filter values
                        let designationStatus = '';

                        // Get Designation value
                        filterDesignation.forEach(r => {

                            if (r.checked) {
                                designationStatus = r.value;
                            }

                            // Reset Designation value if "All" is selected
                            if (designationStatus === 'all') {
                                designationStatus = '';
                            }
                        });

                        // Filter datatable --- official docs reference: https://datatables.net/reference/api/search()
                        dt.search(designationStatus).draw();
                    });
                }
            ...
            var handleDeleteRows = () => {
                ...
                deleteButtons.forEach(d => {
                    ...
                    d.addEventListener('click', function(e) {
                        ...
                        var designation_id = d.getAttribute('designation_id');
            ...
            var handleResetForm = () => {
                ...
                if (resetButton) {
                    resetButton.addEventListener('click', function() {
                        // Reset Designation type
                        filterDesignation[0].checked = true;
        ...
        $(document).on("click", ".designation_modal", function() {
            ...
            $.post(ajax_url, {
                action: 'get_selected_designation_data',
                designation_id: designation_id,
                is_ajax: true,
            }, function(result) {
                console.log(result);
                ...
                if (results) {
                    ...
                    $("#initials").val(results.designation_info.initials);
                    $("#designation").val(results.designation_info.name);
