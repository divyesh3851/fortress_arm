...
if (siget('advisor_id')) {
    $get_selected_advisor_data = Advisor()->get_selected_advisor_data(siget('advisor_id'));
}

if (!$get_selected_advisor_data) {
...
$birth_date = ($get_selected_advisor_data->birth_date) ? date("d, F Y ", strtotime($get_selected_advisor_data->birth_date)) : '';

$anniversary_date = ($get_selected_advisor_data->anniversary_date) ? date("d, F Y ", strtotime($get_selected_advisor_data->anniversary_date)) : '';

$spouses_birthdate = (Advisor()->get_advisor_meta($get_selected_advisor_data->id, "spouses_birthdate")) ? date("d, F Y ", strtotime(Advisor()->get_advisor_meta($get_selected_advisor_data->id, "spouses_birthdate"))) : '';

$type_of_licenses = ($get_selected_advisor_data->licenses_type) ? explode(',', $get_selected_advisor_data->licenses_type) : array();

$carrier_with_business = ($get_selected_advisor_data->carrier_with_business) ? explode(',', $get_selected_advisor_data->carrier_with_business) : array();

$production_percentages = ($get_selected_advisor_data->production_percentages) ? explode(',', $get_selected_advisor_data->production_percentages) : array();

$markets = ($get_selected_advisor_data->markets) ? explode(',', $get_selected_advisor_data->markets) : array();

$get_advisor_extra_contact = Advisor()->get_advisor_extra_contact($get_selected_advisor_data->id); ?>
                                    ...
                                    <div class="card-body pt-10">
                                        ...
                                        <div class="stepper stepper-links d-flex flex-column pt-5" id="kt_create_account_stepper">
                                            ...
                                            <form class=" w-100 pt-15 pb-10" novalidate="novalidate" id="kt_create_account_form" method="post" enctype="multipart/form-data">
                                                <input type="hidden" name="advisor_id" value="<?php echo $get_selected_advisor_data->id; ?>">
                                                <!--begin::Step 1-->
                                                    ...
                                                    <div class="w-100">
                                                        <div class="row mb-7">
                                                            ...
                                                            <div class="fv-row col-md-3 mb-7">
                                                                ...
                                                                <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                                                                    ...
                                                                    <?php
                                                                    $profile_img = Advisor()->get_advisor_meta($get_selected_advisor_data->id, 'profile_img');
                                                        ...
                                                        <div class="row mb-7">
                                                            <div class="col-md-2 fv-row">
                                                                ...
                                                                <select name="prefix" id="prefix" data-control="select2" data-placeholder="Select a Title..." class="form-select form-select-solid" required>
                                                                    ...
                                                                    <?php foreach (Settings()->get_name_prefix_list() as $prefix_result) { ?>
                                                                        <option <?php echo ($get_selected_advisor_data->prefix ==  $prefix_result) ? 'selected' : '';  ?> value="<?php echo $prefix_result; ?>"><?php echo $prefix_result; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="col-md-4 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="preferred_name" id="preferred_name" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="Preferred Name" value="<?php echo $get_selected_advisor_data->preferred_name; ?>" required />
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="col-md-3 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="license_no" id="license_no" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="License No" value="<?php echo $get_selected_advisor_data->license_no; ?>" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="col-md-3 fv-row">
                                                                <!--begin::Label-->
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="npn_no" id="npn_no" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="NPN No" value="<?php echo $get_selected_advisor_data->npn_no; ?>" />
                                                                <!--end::Input-->
                                                            </div>
                                                        </div>
                                                        <div class="row mb-7">
                                                            <div class="col-md-3 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="first_name" id="first_name" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="First Name" value="<?php echo $get_selected_advisor_data->first_name; ?>" required />
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="col-md-3 fv-row">
                                                                <!--begin::Label-->
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="middle_name" id="middle_name" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="Middle Name" value="<?php echo $get_selected_advisor_data->middle_name; ?>" required />
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="col-md-3 fv-row">
                                                                <!--begin::Label-->
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="last_name" id="last_name" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="Last Name" value="<?php echo $get_selected_advisor_data->last_name; ?>" required />
                                                                <!--end::Input-->
                                                            </div>
                                                        ...
                                                        <div class="row mb-7">
                                                            <div class="col-md-3 fv-row">
                                                                ...
                                                                <select name="gender" id="gender" data-control="select2" data-placeholder="Select a Gender..." class="form-select form-select-solid is_empty" required>
                                                                    ...
                                                                    <?php foreach (Settings()->get_gender_type_list() as $gender_result) { ?>
                                                                        <option <?php echo ($get_selected_advisor_data->gender ==  $gender_result) ? 'selected' : '';  ?> value="<?php echo $gender_result; ?>"><?php echo $gender_result; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="col-md-3 fv-row">
                                                                ...
                                                                <select name="advisor_status" id="advisor_status" data-control="select2" data-placeholder="Select a Status..." class="form-select form-select-solid is_empty" required>
                                                                    ...
                                                                    <?php foreach (Settings()->get_advisor_status_list() as $key => $advisor_status_result) { ?>
                                                                        <option <?php echo ($get_selected_advisor_data->advisor_status ==  $key) ? 'selected' : '';  ?> value="<?php echo $key; ?>"><?php echo $advisor_status_result; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="col-md-3 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="city" id="city" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="City" value="<?php echo $get_selected_advisor_data->city; ?>" required />
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="col-md-3 fv-row">
                                                                <!--begin::Label-->
                                                                ...
                                                                <select name="state" id="state" data-control="select2" data-placeholder="Select a State..." class="form-select form-select-solid is_empty" required>
                                                                    ...
                                                                    <?php foreach ($get_state_list as $state_result) { ?>
                                                                        <option <?php echo ($get_selected_advisor_data->state ==  $state_result) ? 'selected' : '';  ?> value="<?php echo $state_result; ?>"><?php echo $state_result; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                                <!--end::Input-->
                                                            </div>
                                                        ...
                                                        <div class="row mb-7">
                                                            ...
                                                            <div class="col-md-3 fv-row">
                                                                ...
                                                                <select name="marital_status" id="marital_status" data-control="select2" data-placeholder="Select a Status..." class="form-select form-select-solid is_empty" required>
                                                                    <option value="">Select Status</option>
                                                                    <option <?php echo ($get_selected_advisor_data->marital_status == 'Married') ? 'selected' : ''; ?> value="Married">Married</option>
                                                                    <option <?php echo ($get_selected_advisor_data->marital_status == 'Unmarried') ? 'selected' : ''; ?> value="Unmarried">Unmarried</option>
                                                                </select>
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="col-md-3 fv-row">
                                                        ...
                                                        <div class="row mb-7">
                                                            <div class="col-md-3 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="spouses_name" id="spouses_name" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="Spouses Name" value="<?php echo Advisor()->get_advisor_meta($get_selected_advisor_data->id, "spouses_name"); ?>" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="col-md-3 fv-row">
                                                                <!--begin::Label-->
                                                            ...
                                                            <div class="col-md-3 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="total_children" id="total_children" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="How Many Children" value="<?php echo Advisor()->get_advisor_meta($get_selected_advisor_data->id, "total_children"); ?>" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="col-md-3 fv-row">
                                                                <!--begin::Label-->
                                                                ...
                                                                <select name="lead_source" id="lead_source" data-control="select2" data-placeholder="Select a Source..." class="form-select form-select-solid is_empty">
                                                                    ...
                                                                    <?php foreach ($get_lead_source_list as $lead_source_result) { ?>
                                                                        <option <?php echo ($get_selected_advisor_data->lead_source ==  $lead_source_result->id) ? 'selected' : ''; ?> value="<?php echo $lead_source_result->id; ?>"><?php echo $lead_source_result->type; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                                <!--end::Input-->
                                                            </div>
                                                                ...
                                                                <div class="card-body pt-0">
                                                                    <div class="row mb-4">
                                                                        <div class="col-md-6 fv-row">
                                                                            ...
                                                                            <!--end::Label-->
                                                                            <!--begin::Input-->
                                                                            <input type="text" name="email_opt_out" id="email_opt_out" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="Email Opt Out" value="<?php echo Advisor()->get_advisor_meta($get_selected_advisor_data->id, "email_opt_out"); ?>" />
                                                                            <!--end::Input-->
                                                                        </div>
                                                                        <!--begin::Input wrapper-->
                                                                        <div class="col-md-6 fv-row">
                                                                            ...
                                                                            <!--end::Label-->
                                                                            <!--begin::Input-->
                                                                            <input type="url" name="facebook_url" id="facebook_url" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="Facebok URL" value="<?php echo Advisor()->get_advisor_meta($get_selected_advisor_data->id, "facebook_url"); ?>" />
                                                                            <!--end::Input-->
                                                                        </div>
                                                                    </div>
                                                                    <div class="row mb-4">
                                                                        <div class="col-md-6 fv-row">
                                                                            ...
                                                                            <!--end::Label-->
                                                                            <!--begin::Input-->
                                                                            <input type="url" name="linkedin_url" id="linkedin_url" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="LinkedIn URL" value="<?php echo Advisor()->get_advisor_meta($get_selected_advisor_data->id, "linkedin_url"); ?>" />
                                                                            <!--end::Input-->
                                                                        </div>
                                                                        <!--end::Input wrapper-->
                                                                        <!--begin::Input wrapper-->
                                                                        <div class="col-md-6 fv-row">
                                                                            ...
                                                                            <!--end::Label-->
                                                                            <!--begin::Input-->
                                                                            <input type="url" name="youtube_url" id="youtube_url" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="Youtube URL" value="<?php echo Advisor()->get_advisor_meta($get_selected_advisor_data->id, "youtube_url"); ?>" />
                                                                            <!--end::Input-->
                                                                        </div>
                                                                        <!--end::Input wrapper-->
                                                                    </div>
                                                                    <div class="row mb-4">
                                                                        ...
                                                                        <div class="col-md-6 fv-row">
                                                                            ...
                                                                            <!--end::Label-->
                                                                            <!--begin::Input-->
                                                                            <input type="url" name="twitter_url" id="twitter_url" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="Twitter URL" value="<?php echo Advisor()->get_advisor_meta($get_selected_advisor_data->id, "twitter_url"); ?>" />
                                                                            <!--end::Input-->
                                                                        </div>
                                                                        <!--end::Input wrapper-->
                                                                    </div>
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                ...
                                                                                <select name="contact_type" data-control="select2" data-placeholder="Select a type..." class="form-select form-select-solid is_empty" required>
                                                                                    ...
                                                                                    <?php foreach (Settings()->get_contact_type_list() as $contact_type_result) { ?>
                                                                                        <option <?php echo ($get_selected_advisor_data->contact_type ==  $contact_type_result) ? 'selected' : ''; ?> value="<?php echo $contact_type_result; ?>"><?php echo $contact_type_result; ?></option>
                                                                                    <?php } ?>
                                                                                </select>
                                                                            </div>
                                                                            <div class="col-md-3">
                                                                                <label class="required form-label">Primary Phone Number</label>
                                                                                <input type="text" name="mobile_no" class="form-control mb-2 mb-md-0 " placeholder="Enter Primary Phone Number" value="<?php echo $get_selected_advisor_data->mobile_no;  ?>" required />
                                                                            </div>
                                                                            <div class="col-md-3">
                                                                                <label class="required form-label">Primary Email Address</label>
                                                                                <input type="email" name="email" class="form-control mb-2 mb-md-0 " placeholder="Enter Primary Email Address" value="<?php echo $get_selected_advisor_data->email; ?>" required />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="w-100">
                                                        <div class="row mb-7">
                                                            <div class="col-md-3 fv-row">
                                                                ...
                                                                <select name="designation" id="designation" data-control="select2" data-placeholder="Select a Designation..." class="form-select form-select-solid is_empty">
                                                                    ...
                                                                    <?php foreach ($get_designation_list as $designation_result) { ?>
                                                                        <option <?php echo ($get_selected_advisor_data->designation == $designation_result->id) ? 'selected' : ''; ?> value="<?php echo $designation_result->id; ?>"><?php echo $designation_result->initials . ' - ' . $designation_result->name; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="col-md-3 fv-row">
                                                                ...
                                                                <select name="affiliations" id="affiliations" data-control="select2" data-placeholder="Select a Affiliations..." class="form-select form-select-solid is_empty">
                                                                    ...
                                                                    <?php foreach ($get_affiliations_list as $affiliation_result) { ?>
                                                                        <option <?php echo ($get_selected_advisor_data->affiliations == $affiliation_result->id) ? 'selected' : ''; ?> value="<?php echo $affiliation_result->id; ?>"><?php echo $affiliation_result->type; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="col-md-6 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <textarea name="organization" id="organization" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="Are you active within the leadership of any of these organizations, locally or nationally?" /><?php echo Advisor()->get_advisor_meta($get_selected_advisor_data->id, "organization"); ?></textarea>
                                                                <!--end::Input-->
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="col-md-6 fv-row">
                                                                ...
                                                                <select name="carrier_appointed" id="carrier_appointed" data-control="select2" data-placeholder="Select a Carriers..." class="form-select form-select-solid is_empty">
                                                                    ...
                                                                    <?php foreach ($get_carrier_appointed_list as $carrier_appointed_result) { ?>
                                                                        <option <?php echo ($get_selected_advisor_data->carrier_appointed == $carrier_appointed_result->id) ? 'selected' : ''; ?> value="<?php echo $carrier_appointed_result->id; ?>"><?php echo $carrier_appointed_result->type; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                                <!--end::Input-->
                                                            </div>
                                                            ...
                                                            <div class="col-md-4 fv-row">
                                                                ...
                                                                <select name="premium_volume" id="premium_volume" data-control="select2" data-placeholder="Select a Premium Volume..." class="form-select form-select-solid is_empty">
                                                                    ...
                                                                    <?php foreach ($get_premium_volume_list as $premium_volume_result) { ?>
                                                                        <option <?php echo ($get_selected_advisor_data->premium_volume == $premium_volume_result->id) ? 'selected' : ''; ?> value="<?php echo $premium_volume_result->id; ?>"><?php echo $premium_volume_result->type; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                                <!--end::Input-->
                                                            </div>
