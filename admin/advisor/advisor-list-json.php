...
foreach ($advisor_list as $advisor_result) {
    ...
    $name = '<!--begin::User details-->
            <div class="d-flex flex-column">
                <a href="' . site_url() . '/admin/advisor/view-advisor/' . $advisor_result->id . '" class="text-gray-800        text-hover-primary mb-1">' . ' ' . $advisor_result->first_name  . ' ' . $advisor_result->last_name . ' <i class="bi bi-patch-check-fill text-success"></i></a>
