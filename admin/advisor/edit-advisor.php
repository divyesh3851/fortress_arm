                                                    ...
                                                    <div class="w-100">
                                                        ...
                                                        <div class="row mb-7">
                                                            ...
                                                            <div class="col-md-3 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="lead_owner" id="lead_owner" class="form-control form-control-solid mb-3 mb-lg-0 is_empty" placeholder="Lead Owner" value="<?php echo Advisor()->get_advisor_meta($selected_advisor_data->id, "lead_owner"); ?>" />
                                                                <!--end::Input-->
                                                            </div>
                                                        </div>
