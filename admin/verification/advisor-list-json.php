...
$totalRecords = $wpdb->get_var('SELECT COUNT( * ) FROM advisor WHERE is_verified = 0 AND status = 0');

$totalRecordwithFilter = $wpdb->get_var('SELECT COUNT( * ) FROM advisor WHERE is_verified = 0 AND  status = 0');

$advisor_list   = $wpdb->get_results('SELECT * FROM advisor WHERE is_verified = 0 AND status = 0 ORDER BY id DESC');
