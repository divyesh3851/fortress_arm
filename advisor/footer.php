                            ...
                            <div class="col-md-6 col-xxl-4">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                        ...
                                        <!--end::Avatar-->
                                        <!--begin::Name-->
                                        <a href="<?php echo site_url(); ?>/advisor/advisor/view-advisor/<?php echo $greeting_result['id']; ?>" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0"><?php echo $greeting_result['prefix'] . " " . $greeting_result['first_name'] . " " . $greeting_result['last_name']; ?></a>
                                        <!--end::Name-->
