...
if (isset($_POST['password_reset'])) {
    ...
    if (!sipost('email')) {
        ...
        wp_redirect(site_url() . '/advisor/forgot-password');
        die();
    }

    $email = strtolower(sipost('email'));

    $check_user = $wpdb->get_var("SELECT id FROM advisor WHERE email = '" . $email . "' AND status = 0");
    ...
    $response = Advisor()->send_reset_password_mail($check_user);
                    ...
                    <div class="card-body  py-5 py-lg-5">
                        ...
                        <form class="form w-100" method="post">
                            ...
                            <div class="d-flex flex-wrap justify-content-center pb-lg-0">
                                ...
                                <a href="<?php echo site_url(); ?>/advisor" class="btn btn-light">Cancel</a>
                            </div>
                            <!--end::Actions-->
                        </form>
                    </div>
