...
if (isset($_SESSION) && isset($_SESSION['is_fbs_advisor_login']) && isset($_SESSION['fbs_advisor_id'])) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Checked Advisor Login Success Or Not
    $response = Advisor()->login(sipost('email'), sipost('password'));
