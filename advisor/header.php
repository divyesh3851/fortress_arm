<?php
$profile_img = Advisor()->get_advisor_meta($_SESSION['fbs_advisor_id'], 'profile_img');
...
<div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
    ...
    <div class="d-flex flex-stack flex-grow-1 logo_with_header">
        <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
            ...
            <!--begin::Logo-->
            <a href="<?php echo site_url(); ?>/advisor" class="app-sidebar-logo">
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
            ...
            <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
                ...
                <div class="cursor-pointer symbol symbol-circle symbol-30px symbol-lg-45px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                    ...
                    <?php
                    if ($profile_img) { ?>
                        <img src="<?php echo site_url(); ?>/uploads/advisor/<?php echo $profile_img; ?>" alt="user" />
                    <?php } else { ?>
                        <img src="<?php echo site_url(); ?>/uploads/advisor/blank.png" alt="user" />
                    <?php } ?>
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <?php
                                if ($profile_img) { ?>
                                    <img alt="Logo" src="<?php echo site_url(); ?>/uploads/advisor/<?php echo $profile_img; ?>" />
                                <?php } else { ?>
                                    <img alt="Logo" src="<?php echo site_url(); ?>/uploads/advisor/blank.png" />
                                <?php } ?>
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Username-->
                            <div class="d-flex flex-column">
                                <div class="fw-bold d-flex align-items-center fs-5">
                                    <?php
                                    $get_login_info = Advisor()->get_login_advisor_info($_SESSION['fbs_advisor_id']);
                                    echo $get_login_info->first_name . ' ' . $get_login_info->last_name;
                                    ?>
                                </div>
                                <a href="mailto:<?php echo $get_login_info->email; ?>" class="fw-semibold text-muted text-hover-primary fs-7"><?php echo $get_login_info->email; ?></a>
                            </div>
                            <!--end::Username-->
                        </div>
                    </div>
            ...
            <div class="app-navbar-item ms-2 ms-lg-6 me-lg-6">
                <!--begin::Link-->
                <a href="<?php echo site_url() ?>/advisor/logout" class="btn btn-icon btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px">
