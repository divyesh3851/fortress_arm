        ...
        var KTDatatablesServerSide = function() {
            ...
            var initDatatable = function() {
                dt = $("#kt_datatable_example_1").DataTable({
                    ...
                    ajax: {
                        url: "<?php echo site_url(); ?>/advisor/advisor-list-ajax.php",
                        data: {
                        ...
                        },*/
                        {
                            ...
                            render: function(data, type, row) {
                                return `<div class="d-flex">  
                                            ...
                                            <a href="<?php echo site_url(); ?>/advisor/view-advisor/${data.record_id}">
                                                <div class="border border-gray-300 border-dashed rounded pt-2 pb-1 px-3 mb-3 me-2">
                                                    <div class="fs-3 fw-bold text-gray-700">
                                            ...
                                            <a href="<?php echo site_url(); ?>/advisor/edit-advisor/${data.record_id}">
                                                <div class="border border-gray-300 border-dashed rounded pt-2 pb-1 px-3 mb-3 me-2">
                                                    <div class="fs-2 fw-bold text-gray-700">
