...
if (isset($_POST['save_profile'])) {
	...
	wp_redirect(site_url() . '/advisor/verification/view-advisor/' . siget('advisor_id'));
	exit;
}
									...
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
											...
											<li class="breadcrumb-item text-muted">
												<a href="<?php echo site_url(); ?>/advisor/advisor/advisor-list" class="text-muted text-hover-primary">Advisor List</a>
											</li>
											<!--end::Item-->
											<!--begin::Item-->
											...
											<div class="card-body">
												...
												<div class="d-flex flex-stack fs-4 py-3">
													...
													<span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit Advisor Details">
														<a href="<?php echo site_url() ?>/advisor/advisor/edit-advisor/<?php echo $selected_advisor_data->id; ?>" class="btn btn-sm btn-light-primary">Edit</a>
													</span>
												</div>
												<!--end::Details toggle-->
