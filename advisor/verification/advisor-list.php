...
if (sipost('first_name') || sipost('last_name') || sipost('email')) {
    ...
    wp_redirect(site_url() . '/advisor/verification/advisor-list');
    exit;
}
        ...
        var KTDatatablesServerSide = function() {
            ...
            var initDatatable = function() {
                dt = $("#kt_datatable_example_1").DataTable({
                    ...
                    ajax: {
                        url: "<?php echo site_url(); ?>/advisor/verification/advisor-list-ajax.php",
                        data: {
                            fbs_advisor_id: '<?php echo $_SESSION['fbs_advisor_id']; ?>'
                        }
                    },
                    columns: [{
                            data: 'record_id'
        ...
        var verification_sent_datatable = function() {
            ...
            var initDatatable = function() {
                dt = $("#verification_sent_datatable").DataTable({
                    ...
                    ajax: {
                        url: "<?php echo site_url(); ?>/advisor/verification/advisor-list-sent-verification-ajax.php",
                        data: {
                            fbs_advisor_id: '<?php echo $_SESSION['fbs_advisor_id']; ?>'
                        }
                    },
                    ...
                    columnDefs: [{
                        ...
                        },*/
                        {
                            ...
                            render: function(data, type, row) {
                                return `<div class="d-flex">  
                                            <a href="<?php echo site_url(); ?>/advisor/advisor/edit-advisor/${data.record_id}" class="badge badge-light-info flex-shrink-0 align-self-center py-3 px-4 fs-7 me-2 cursor-pointer" title="Complete Now">Complete Now</a>
                                            <a href="tel:${data.mobile_no}">
                                                <div class="border border-gray-300 border-dashed rounded pt-2 pb-1 px-3 mb-3 me-2">
                                                    <div class="fs-3 fw-bold text-gray-700">
                                                        <i class="las la-phone-volume fs-2 text-success"></i>
