...
$get_current_campaign = $wpdb->get_row("SELECT campaign_id FROM campaign_user WHERE user_id = " . $selected_advisor_data->id); ?>
                                    ...
                                    <div class="card-body pt-10">
                                        <div class="row">
                                            <div class="text-center">
                                                ...
                                                <h2 class="mt-10 mb-10">Please complete your profile</h2>
                                            </div>
                                        </div>
